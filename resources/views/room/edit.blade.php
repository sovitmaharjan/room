                        ...
                        <form method="post" action="{{ route('room.update', $room->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="room_type_id" name="room_type_id" required>
                                    ...
                                    @foreach ($room_type as $item)
                                        <option value="{{ $item->id }}" @selected(old('room_type', $room->room_type_id))>{{ $item->title }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" id="image" name="image" class="dropify" data-height="200"
                                    data-default-file="{{ $room->getFirstMediaUrl('image') }}" />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="checkbox" class="" id="availability" name="availability" value="1"
                                    {{ $room->availability == 0 ? '' : 'checked' }}>
                            </div>
                            <div class="form-group">
