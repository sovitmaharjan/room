            ...
            <div class="card-box">
                ...
                <div class="row">
                    <div class="col-lg-12 m-t-20">
                        <form method="post" action="{{ route('room-type.update', $room_type->id) }}">
                            @csrf
                            @method('patch')
                            <div class="form-group">
                                <label for="title">Title</label>
                                <input type="text" class="form-control" id="title" name="title" placeholder="Title" value="{{ old('title', $room_type->title) }}" required>
                            </div>
                            <div class="form-group">
